...
hyper_list = MLBenchmarks.get_hyper_neurotrees(; loss=:mse, metric=:mse, device=:gpu, nrounds=200, early_stopping_rounds=2, lr=1e-3, ntrees=[32, 64, 128], stack_size=[1], depth=[3, 4, 5], hidden_size=[8, 16, 32], init_scale=1.0, batchsize)
