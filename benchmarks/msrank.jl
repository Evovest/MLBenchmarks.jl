...
hyper_list = MLBenchmarks.get_hyper_neurotrees(; loss=:mse, metric=:mse, nrounds=200, early_stopping_rounds=2, lr=1e-3, ntrees=[32, 64, 128, 256], stack_size=[1], depth=[3, 4, 5], hidden_size=[8, 16, 32, 64], init_scale=0.1, batchsize)
