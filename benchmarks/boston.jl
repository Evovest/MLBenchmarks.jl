...
loss = "cred_std"
hyper_list = MLBenchmarks.get_hyper_evotrees(; loss, metric="mse", nrounds=1000, early_stopping_rounds=10, eta=0.05, max_depth=5:2:11, rowsample=[0.4, 0.6, 0.8, 1.0], colsample=[0.4, 0.6, 0.8, 1.0], lambda=[0], L2=[0, 1, 10])
